...
public class BeerServiceImpl implements BeerService {
	...
	public BeerServiceImpl(RestTemplateBuilder restTemplateBuilder) { this.restTemplate = restTemplateBuilder.build(); }
	...
	public void setBeerServiceHost(String serviceHost) { this.beerServiceHost = serviceHost; }
